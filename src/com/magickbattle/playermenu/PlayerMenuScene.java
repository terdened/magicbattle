...
public class PlayerMenuScene extends BaseScene implements IOnMenuItemClickListener, IOnSceneTouchListener 
{
    ...
    private void createBackground()
    {
    	...
    	scrollMenu.getCirclesList().getLast().addButton(100, 520, resourcesManager.level_point_region, vbom, "4",this);
    	scrollMenu.getCirclesList().getLast().addButton(100, 700, resourcesManager.level_point_region, vbom, "5",this);
