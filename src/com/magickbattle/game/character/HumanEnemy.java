...
import com.magickbattle.game.ai.HumanAI;
...
public class HumanEnemy extends Enemy{
	...
	public HumanEnemy(GameScene scene, float pX, float pY,
			VertexBufferObjectManager vbo, Camera camera,
			PhysicsWorld physicsWorld, ResourcesManager pResourcesManager) {
		super(scene, pX, pY, vbo, camera, physicsWorld, pResourcesManager.human_region.mPlayerRegion);
