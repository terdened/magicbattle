...
import com.magickbattle.game.ai.SpiderAI;
...
public class SpiderEnemy extends Enemy{
	...
	public SpiderEnemy(GameScene scene, float pX, float pY,
			VertexBufferObjectManager vbo, Camera camera,
			PhysicsWorld physicsWorld, ResourcesManager pResourcesManager) {
		super(scene, pX, pY, vbo, camera, physicsWorld, pResourcesManager.spider_region.mPlayerRegion);
