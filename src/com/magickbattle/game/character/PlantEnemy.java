...
import com.magickbattle.game.ai.PlantAI;
...
public class PlantEnemy extends Enemy{
	...
	public PlantEnemy(GameScene scene, float pX, float pY,
			VertexBufferObjectManager vbo, Camera camera,
			PhysicsWorld physicsWorld, ResourcesManager pResourcesManager) {
		super(scene, pX, pY, vbo, camera, physicsWorld, pResourcesManager.plant_region.mPlayerRegion);
	...
	public void attackPlayer()
	{
		...
		if(this.getY()>mScene.player.playerY)
 		 ...
 		 temp.add(new Bulet(mScene.resourcesManager.plant_region.mBuletRegion,getDamage(),
	...
	public void heal(int pPower)
	{
		this.attacked(-pPower);
	}
}
