...
public class WormEnemy extends Enemy{
	...
	public WormEnemy(GameScene scene, float pX, float pY,
			VertexBufferObjectManager vbo, Camera camera,
			PhysicsWorld physicsWorld, ResourcesManager pResourcesManager) {
		super(scene, pX, pY, vbo, camera, physicsWorld, pResourcesManager.worm_region.mPlayerRegion);
